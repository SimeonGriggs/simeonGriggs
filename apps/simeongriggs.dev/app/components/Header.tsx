...
export const buttonClasses =
  'flex items-center justify-center p-1 size-6 text-blue-500 rounded-full bg-white hover:bg-blue-950 hover:text-white'
  ...
  return (
    <header className={menuClasses}>
      <div className="flex items-center justify-center border-l-2 border-r-2 border-blue-500 bg-blue-500 px-3 py-2 font-mono text-white md:w-full md:flex-col md:border-none md:py-8">
        <Link
          to="/"
          className="md:text-vertical flex items-center justify-center hover:bg-blue-950"
        >
          {title}
        </Link>
