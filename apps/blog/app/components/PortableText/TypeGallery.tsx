...
export default function TypeGallery(
  props: PortableTextTypeComponentProps<TypedObjectGallery>,
) {
  // Now we still get Zod's strict parsing on this specific TypedObject
  const {images} = React.useMemo(
    () => typedObjectGalleryZ.parse(props.value),
    [props.value],
  )
  ...
  return (
    <div
      // className="prose prose-blue my-4 dark:prose-dark md:prose-lg md:my-8"
