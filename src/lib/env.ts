...
export const APP_PORT = getEnv('PORT') || '5173'
...
export const SITE_URL = GITPOD_WORKSPACE_URL || GITHUB_CODESPACE_URL || VERCEL_URL || APP_URL
...
export const IS_HOSTED = IS_GITPOD_WORKSPACE || IS_GITHUB_CODESPACE || IS_VERCEL || !IS_LOCALHOST
